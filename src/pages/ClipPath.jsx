    ...
    <>
      ...
      <div className='flex w-full gap-8'>
        <div className='relative w-full h-96'>
          <img
            src='https://images.unsplash.com/photo-1619314367523-bc28b916dd9d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&ixlib=rb-1.2.1&q=80&w=1600'
            style={{ clipPath: 'url(#svg__wave)' }}
          />
          {clipPathSVG && (
            <svg xmlns={clipPathSVG.xmlns} className='w-0 h-0'>
              <defs>
                <clipPath id='svg__wave' clipPathUnits='objectBoundingBox'>
                  {clipPathSVG.paths.map((p, index) => {
                    return <path d={p.d} key={index} transform={p.transform} />;
                  })}
                </clipPath>
              </defs>
            </svg>
